...
import com.oneThing.domain.model.SaveMatch
...
class DatabaseRepositoryImpl @Inject constructor(
    ...
    override suspend fun getUserInfo(): com.oneThing.domain.model.UserData {
    ...
    private fun UserInfo.toDomain(): com.oneThing.domain.model.UserData {
        return com.oneThing.domain.model.UserData(
            userName = name,
            nickName = nickName,
            phoneNumber = phoneNumber,
            job = job,
