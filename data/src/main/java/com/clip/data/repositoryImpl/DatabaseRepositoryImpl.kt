...
import com.clip.domain.model.SaveMatch
...
class DatabaseRepositoryImpl @Inject constructor(
    ...
    override suspend fun getUserInfo(): com.clip.domain.model.UserData {
    ...
    private fun UserInfo.toDomain(): com.clip.domain.model.UserData {
        return com.clip.domain.model.UserData(
            userName = name,
            nickName = nickName,
            phoneNumber = phoneNumber,
            job = job,
